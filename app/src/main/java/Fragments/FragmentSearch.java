...
//Populer ürünler
        ...
        call2.enqueue(new Callback<ProductResponse>() {
            ...
            public void onResponse(Call<ProductResponse> call, Response<ProductResponse> response) {
                ...
                adapterk = new KesfetAdapter(products,mContext);
...
//Discrete Ürünleri getir
        ...
        call1.enqueue(new Callback<ProductResponse>() {
            ...
            public void onResponse(Call<ProductResponse> call, Response<ProductResponse> response) {
                ...
                discreteAdapter = new SearchDiscreteAdapter(products,mContext);
                        ...
                        public void onResponse(Call<SearchResponse> call, Response<SearchResponse> response) {
                            if (response.body() != null) {
                                ...
                                if (items.size() != 0) {
                                    ...
                                    searchAdapter = new SearchAdapter(items,mContext);
...
//İndirimli ürünleri görüntüle
        ...
        call3.enqueue(new Callback<ProductResponse>() {
            ...
            public void onResponse(Call<ProductResponse> call, Response<ProductResponse> response) {
                ...
                RecentAdapter adapter1 = new RecentAdapter(products,mContext);
