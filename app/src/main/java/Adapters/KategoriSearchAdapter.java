...
public class KategoriSearchAdapter extends RecyclerView.Adapter<KategoriSearchAdapter.ViewHolder> {

    private List<Categorie> mKategoriler;
    private Context mContext;


    public KategoriSearchAdapter(List<Categorie> mKategoriler, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.kategori_search_cardview,viewGroup,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
     ...
     kategoriname=itemView.findViewById(R.id.titlekat);
